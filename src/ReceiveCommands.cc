...
vector<MenuItem> quest_categories_menu({
  ...
  MenuItem(static_cast<uint32_t>(QuestCategory::EXTERMINATION), u"Emergency", u"$E$C6Limited time\nemergency missions", 0),
  MenuItem(static_cast<uint32_t>(QuestCategory::EVENT), u"Holiday", u"$E$C6Quests related to\nthe current season\nor holiday", 0),
